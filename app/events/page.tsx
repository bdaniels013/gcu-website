...
import { Container, Eyebrow, LinedHeading } from "@/components/ui";
      ...
      <section className="relative bg-ink">
        ...
        <Container className="py-16">
          <div className="text-center">
            <LinedHeading>Events</LinedHeading>
          </div>
          {featured && (
            <section id={featured.id} className="mt-12 scroll-mt-28">
          ...
          <section className="mt-16 rounded-3xl border border-black/10 bg-ink-soft p-10 text-center">
            ...
            <a
              href="/contact"
              className="mt-7 inline-flex rounded-[3px] bg-teal px-6 py-3 text-sm font-medium uppercase tracking-[0.12em] text-white transition-colors hover:bg-teal-deep"
            >
              Connect With Us
            </a>
          </section>
